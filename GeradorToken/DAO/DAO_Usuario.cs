...
namespace GeradorToken.DAO
{
    public class DAO_Usuario
    {
        public Usuario CadastrarUsuario(Usuario usu)
        {
            ...
            try
            {
                string sqlUsuario = $@"INSERT INTO Usuario (nome,email,senhacriptografada) OUTPUT INSERTED.id VALUES (@nome, @email, @senhacriptografada)"; //NUNCA CONCATENAR STRING AQUI, PELA MOR DE DEUS ....
